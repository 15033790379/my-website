...
/******/ 			var chunk = require("./" + ({"1":"layouts/default","2":"pages/_page","3":"pages/blog/_slug","4":"pages/blog/index","5":"pages/blog/page/_page","6":"pages/index"}[chunkId]||chunkId) + ".js");
...
module.exports = JSON.parse("{\"title\":\"Home\",\"titleTemplate\":\"| Bluise\",\"welcomeText\":\"# Yo, I'm Bluise - A Nuxt.js & Netlify CMS boilerplate.\\n\\nAuthentic cred hoodie hashtag selfies. Raclette banjo cardigan cred. Kitsch XOXO lomo polaroid. Knausgaard put a bird on it four dollar toast leggings typewriter asymmetrical.\",\"logo\":\"/images/uploads/logo.svg\",\"icon\":\"/images/uploads/logo.png\",\"loadingColor\":\"#0b3765\",\"seoDescription\":\"A quickstart for Nuxt & Netlify CMS\",\"seoMetaImage\":\"\"}");
...
var map = {
	"./blog/cat.json": 8,
	"./blog/la-croix.json": 9,
	"./blog/meditation-pop-up-forage.json": 10,
	"./blog/pug-swag.json": 11,
	"./blog/test1.json": 12,
	"./pages/about.json": 13,
	"./pages/test.json": 14,
	"./settings/general.json": 19,
	"./settings/manifest.json": 26
};
...
module.exports = JSON.parse("{\"name\":\"Bluise\",\"shortName\":\"Bluise\",\"description\":\"A Nuxt.js & Netlify CMS boilerplate.\",\"themeColor\":\"#0b3765\",\"backgroundColor\":\"#ffffff\",\"lang\":\"en\"}");
...
const _231e5942 = () => interopDefault(__webpack_require__.e(/* import() | pages/blog/index */ 4).then(__webpack_require__.bind(null, 39)));

const _71f990a4 = () => interopDefault(__webpack_require__.e(/* import() | pages/blog/page/_page */ 5).then(__webpack_require__.bind(null, 51)));

const _2167b7fa = () => interopDefault(__webpack_require__.e(/* import() | pages/blog/_slug */ 3).then(__webpack_require__.bind(null, 47)));

const _58bc6e45 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 6).then(__webpack_require__.bind(null, 48)));

const _7d049a3e = () => interopDefault(__webpack_require__.e(/* import() | pages/_page */ 2).then(__webpack_require__.bind(null, 49))); // TODO: remove in Nuxt 3
...
// EXTERNAL MODULE: ./app/assets/css/tailwind.css
var tailwind = __webpack_require__(23);

// EXTERNAL MODULE: ./app/assets/css/main.scss
...
const _6f6c098b = () => __webpack_require__.e(/* import() | layouts/default */ 1).then(__webpack_require__.bind(null, 46)).then(m => sanitizeComponent(m.default || m));
...
(function updateModules() {
  store_store = normalizeRoot(__webpack_require__(31), 'store/index.ts'); // If store is an exported method = classic mode (deprecated)
...
/* harmony default export */ var nuxt_icons = (async function (ctx, inject) {
  const icons = {
    "64x64": "/_nuxt/icons/icon_64.bd5fbc.png",
    "120x120": "/_nuxt/icons/icon_120.bd5fbc.png",
    "144x144": "/_nuxt/icons/icon_144.bd5fbc.png",
    "152x152": "/_nuxt/icons/icon_152.bd5fbc.png",
    "192x192": "/_nuxt/icons/icon_192.bd5fbc.png",
    "384x384": "/_nuxt/icons/icon_384.bd5fbc.png",
    "512x512": "/_nuxt/icons/icon_512.bd5fbc.png"
  };
...
var external_markdown_it_ = __webpack_require__(18);
  ...
  const app = {
    head: {
      ...
      "meta": [{
        ...
        "hid": "description",
        "name": "description",
        "content": "A quickstart for Nuxt & Netlify CMS"
      }, {
        "hid": "og:title",
        "property": "og:title",
        "content": "Home | Bluise"
      ...
      "link": [{
        ...
        "rel": "manifest",
        "href": "\u002F_nuxt\u002Fmanifest.6bf3c196.json"
      }, {
        "rel": "shortcut icon",
        "href": "\u002F_nuxt\u002Ficons\u002Ficon_64.bd5fbc.png"
      }, {
        "rel": "apple-touch-icon",
        "href": "\u002F_nuxt\u002Ficons\u002Ficon_512.bd5fbc.png",
        "sizes": "512x512"
      }],
      "style": [],
      "htmlAttrs": {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "appState", function() { return /* binding */ appState; });
...
async function getContent({
  ...
  for (let index = 0; index < slugs.length; index += 1) {
    ...
    const entry = __webpack_require__(25)(`./${prefix}/${slug}.json`); // Add the slug to the post object
...
const mutations = {
  SET_PAGES: (state, payload) => {
    external_vue_default.a.set(state, 'pages', payload);
  },
  SET_POSTS: (state, payload) => {
    external_vue_default.a.set(state, 'posts', payload);
  }
};
const actions = {
  async GET_POSTS_LIST({
    ...
    const context = await __webpack_require__(27);
  ...
  async GET_PAGES_LIST({
    ...
    // Use webpack to search the blog directory matching .json files
    const context = await __webpack_require__(28);
